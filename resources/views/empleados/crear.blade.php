                        ...
                        <div class="row">
                            <div class="col-xs-3 col-sm-3 col-md-3">
                                <div class="form-group">
                                   ...
                                   <input type="text" name="nombre_emp_1" class="form-control">
                                </div>
                            </div>
                            <div class="col-xs-3 col-sm-3 col-md-3">
                                <div class="form-group">
                                   <label for="nombre_emp_2">Segundo Nombre</label>
                                   <input type="text" name="nombre_emp_2" class="form-control">
                                </div>
                            </div>    
                        </div>
                        <div class="row">
                            <div class="col-xs-3 col-sm-3 col-md-3">
                                <div class="form-group">
                                   ...
                                   <input type="text" name="apellido_emp_1" class="form-control">
                                </div>
                            </div>
                            <div class="col-xs-3 col-sm-3 col-md-3">
                                <div class="form-group">
                                   <label for="apellido_emp_2">Segundo Apellido</label>
                                   <input type="text" name="apellido_emp_2" class="form-control">
                                </div>
                            </div>
                            <div class="col-xs-3 col-sm-3 col-md-3">
                                <div class="form-group">
                                   <label for="dpi_emp">DPI</label>
                                   <input type="text" name="dpi_emp" class="form-control">
                                </div>
                            </div>
                            <div class="col-xs-3 col-sm-3 col-md-3">
                                <div class="form-group">
                                   <label for="nit_emp">NIT</label>
                                   <input type="text" name="nit_emp" class="form-control">
                                </div>
                            </div>
                            <div class="col-xs-3 col-sm-3 col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-xs-3 col-sm-3 col-md-3">
                                <div class="form-group">
                                   ...
                                   <input type="text" name="telefono_emp2" class="form-control">
                                </div>
                            </div> 
                            <div class="col-xs-3 col-sm-3 col-md-3">
                                <div class="form-group">
