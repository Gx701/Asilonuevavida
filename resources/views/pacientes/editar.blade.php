                      ...
                      <div class="row">
                        <div class="col-xs-3 col-sm-3 col-md-3">
                            <div class="form-group">
                               ...
                               <input type="text" name="nombre_pa_1" class="form-control" value="{{$paciente->nombre_pa_1}}">
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3">
                            <div class="form-group">
                               <label for="nombre_pa_2">Segundo Nombre</label>
                               <input type="text" name="nombre_pa_2" class="form-control" value="{{$paciente->nombre_pa_2}}">
                            </div>
                        </div>    
                    </div>
                    <div class="row">
                        <div class="col-xs-3 col-sm-3 col-md-3">
                            <div class="form-group">
                               ...
                               <input type="text" name="apellido_pa_1" class="form-control" value="{{$paciente->apellido_pa_1}}">
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3">
                            <div class="form-group">
                               <label for="apellido_ma_2">Apellido Materno</label>
                               <input type="text" name="apellido_ma_2" class="form-control" value="{{$paciente->apellido_ma_2}}">
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3">
                            <div class="form-group">
                               <label for="dpi_pa">DPI</label>
                               <input type="text" name="dpi_pa" class="form-control" value="{{$paciente->dpi_pa}}">
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3">
                            <div class="form-group">
                               <label for="nit_pa">NIT</label>
                               <input type="text" name="nit_pa" class="form-control" value="{{$paciente->nit_pa}}">
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3">
                            <div class="form-group">
                        ...
                        <div class="col-xs-3 col-sm-3 col-md-3">
                            <div class="form-group">
                               ...
                               <input type="text" name="telefono_pa" class="form-control" value="{{$paciente->telefono_pa}}">
                            </div>
                        </div> 
                        ...
                        <div class="col-xs-3 col-sm-3 col-md-3">
                          <div class="form-group">
                             ...
                             <select name="id_tipo_sangre" id="id_tipo_sangre">
                              <option value="">---Cambier el Tipo de Sangre---</option>
                      ...
                      <div class="col-xs-3 col-sm-3 col-md-3">
                        <div class="form-group">
                           ...
                           <select name="sexo" id="sexo">
                            <option value="">---Cambier el Sexo---</option>
                        ...
                        <div class="col-xs-3 col-sm-3 col-md-3">
                            <div class="form-group">
                               ...
                               <select name="id_religion" id="id_religion">
                                <option value="">---Cambier religion---</option>
                        ...
                        <div class="col-xs-3 col-sm-3 col-md-3">
                          <div class="form-group">
                             ...
                             <select name="id_responsable" id="id_responsable">
                              <option value="">---Cambier de Responsable---</option>
                        ...
                        <div class="file-upload">
                            ...
                            <div class="file-upload-content">
                              <img class="file-upload-image" src="/img/{{ $paciente->foto_paciente }}" alt="your image" />
